  ...
  module Core
    module Models
      ...
      class ImageModel < BaseModel
        ...
        const_set(:DEFAULT_IMAGE_POS_X,   0)
        const_set(:DEFAULT_IMAGE_POS_Y,   0)
        ...
        def initialize(options={}, &block)
          ...
          @image_pos_x  = DEFAULT_IMAGE_POS_X
          @image_pos_y  = DEFAULT_IMAGE_POS_Y
        ...
        [:pos_x, :pos_y].each do |m|
          define_method "#{ m }" do |value|
            instance_variable_set("@image_#{ m }", valiue.to_s.to_sym)
          end
        end
        ...
        def option_keys
          [:url, :width, :height, :align, :top, :bottom, :left, :right, :pos_x, :pos_y]
        end
